...
async def problem(bot, message, problem_id):
    """
    ...
    try:
        ...
        await message.channel.send("Please make sure that you asking for a problem number, not a problem name")  # Tell them that they messed up
        return
